...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 `rg -n 'actions/cache@|GOFLAGS|restore-keys|hashFiles' .github/workflows/ci.yaml` shows the SHA-pinned cache step, `-count=1`, a `go.sum` hash in the key, and a fallback key.
