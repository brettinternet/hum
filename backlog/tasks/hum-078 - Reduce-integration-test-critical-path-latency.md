...
Scope: integration-test orchestration, synchronization, fixtures, and test-only helpers. Measure base and candidate revisions with identical commands on the same machine or runner and record all raw wall times plus the median in Implementation Notes.
