...
- [ ] #2 Fresh-clone instructions build hum and every documented serve/run/list/status/logs/wait/restart/stop/shutdown/skill example is exercised against a temporary runtime directory with the stated result.
