...
4. These remain non-goals and are documented as such (HUM-114): TUI and web UI (Herdr provides panes), reverse proxy and port management, cron scheduling, boot start, shell-hook autostart, file-watch restarts, liveness/health monitoring, log parsing or query languages, runtime shell interpretation or templating, and Windows.
